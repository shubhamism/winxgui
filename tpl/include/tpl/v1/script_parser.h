...
// this software.
// 
// Module: tpl/v1/script_parser.h
// Creator: xushiwei
// Email: xushiweizh@gmail.com
// Date: 4/20/2003 19:10:13
// History:
...
// 
// $Id: script_parser.h,v 1.4 2006/12/03 05:33:33 xushiwei Exp $
// -----------------------------------------------------------------------*/
#ifndef __TPL_V1_SCRIPT_PARSER_H__
#define __TPL_V1_SCRIPT_PARSER_H__
...
struct KRule
{
	...
	public:
		...
		{
			return STD_NEW(m_alloc, KRule)(match_string_const, string_const);
		}
		STDMETHODIMP_(KRule*) NewRepeatRule(KRule* rule)
		{
			return STD_NEW(m_alloc, KRule)(match_rule_repeat, rule);
		}
		STDMETHODIMP_(KRule*) NewOrRule(RuleList* rules)
		{
			return STD_NEW(m_alloc, KRule)(match_rule_or, rules);
		}
		STDMETHODIMP_(KRule*) NewAndRule(RuleList* rules)
		{
			return STD_NEW(m_alloc, KRule)(match_rule_and, rules);
		}
		STDMETHODIMP_(KRule*) NewRuleMatchAll()
		{
			return STD_NEW(m_alloc, KRule)(match_all, NULL);
		}
		STDMETHODIMP_(MatchRule*) NewMRule()
		{
			return STD_NEW(m_alloc, MatchRule);
		}
		STDMETHODIMP_(RuleList*) NewRuleList()
		{
			return STD_NEW(m_alloc, RuleList);
		}
		STDMETHODIMP_(String*) NewString(const char_type* val)
		{
			return STD_NEW(m_alloc, String)(val);
		}
	};
};
...
protected:
		...
		Rule& ruleNext, int limit, pos_type* pos_goto, pos_type* pos_next_rule_start)
	{
		...
		case match_string_const:			{
			...
			std::kmp::Finder<char> finder(strc);
			if (S_OK == finder.next(src, limit))
			{
				*pos_goto = src.tell();
...
// Revision 1.4  2006/12/03 05:33:33  xushiwei
// Manul Tools - Version 1.0
//
// Revision 1.2  2006/12/02 07:57:49  xushiwei
// std::AutoFreeAlloc
//
...
#endif /* __TPL_V1_SCRIPT_PARSER_H__ */
