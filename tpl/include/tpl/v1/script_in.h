...
// this software.
// 
// Module: tpl/v1/script_in.h
// Creator: xushiwei
// Email: xushiweizh@gmail.com
// Date: 4/19/2003 11:50:19 PM
// 
// $Id: script_in.h,v 1.2 2006/12/02 07:57:49 xushiwei Exp $
// -----------------------------------------------------------------------*/
#ifndef __TPL_V1_SCRIPT_IN_H__
#define __TPL_V1_SCRIPT_IN_H__
	...
	public:
		...
		STDMETHODIMP LoadScript(IN const char_type* incPath)
		{
			...
			if (base_path)
			{
				...
				PathCombine(script_in_file, base_path, incPath);
