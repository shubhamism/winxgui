...
#ifndef __VFCSPLIT_H__
#define __VFCSPLIT_H__
...
//
// CLayoutSplitterImpl<T, t_bVertical>
// CLayoutSplitterWindowImpl<T, t_bVertical, TBase, TWinTraits>
// CLayoutSplitterWindowT<t_bVertical>
// typedef CLayoutSplitterWindowT<true>    CLayoutSplitter;
// typedef CLayoutSplitterWindowT<false>   CLayoutHorSplitter;
...
// Constructor
	...
	void SetSplitterVertical(bool bVertical)
	{
...
// Message map and handlers
	BEGIN_MSG_MAP(CLayoutSplitterImpl)
...
class ATL_NO_VTABLE CLayoutSplitterWindowImpl : public ATL::CWindowImpl< T, TBase, TWinTraits >, public CLayoutSplitterImpl< T >
{
public:
...
public:
	...
	typedef CLayoutSplitterImpl< T >   _baseClass;

	BEGIN_MSG_MAP(CLayoutCSplitterWindowImpl)
...
class CLayoutSplitter : public CLayoutSplitterWindowImpl<CLayoutSplitter>
{
public:
	DECLARE_WND_CLASS_EX(_T("WTL_LayoutSplitterWindow"), CS_DBLCLKS, COLOR_WINDOW)
	CLayoutSplitter()
	{
	}
};

class CLayoutHorSplitter : public CLayoutSplitterWindowImpl<CLayoutHorSplitter>
{
public:
	DECLARE_WND_CLASS_EX(_T("WTL_LayoutSplitterWindow"), CS_DBLCLKS, COLOR_WINDOW)
	CLayoutHorSplitter()
	{
		SetSplitterVertical(false);
	}
};
...
/*
class CLayoutSplitterWindow : public CLayoutSplitterWindowImpl<CLayoutSplitterWindowT<t_bVertical>, t_bVertical>
{
public:
	DECLARE_WND_CLASS_EX(_T("WTL_LayoutSplitterWindow"), CS_DBLCLKS, COLOR_WINDOW)
};
...
typedef CLayoutSplitterWindowT<true>    CLayoutSplitterWindow;
typedef CLayoutSplitterWindowT<false>   CLayoutHorSplitterWindow;
*/

}; // namespace WTL

#endif // __VFCSPLIT_H__
