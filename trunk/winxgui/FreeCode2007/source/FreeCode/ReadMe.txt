========================================================================
       DEVELOPER STUDIO ADD-IN : FreeCode
========================================================================


The Add-in Wizard has created this FreeCode DLL for you.  This DLL not only
...
FreeCode.cpp
	This is the main DLL source file.  It contains the class CFreeCodeApp.
...
Commands.cpp, Commands.h
    ...
    a sample command (FreeCodeCommand) which displays a message
...
StdAfx.h, StdAfx.cpp
    ...
    named FreeCode.pch and a precompiled types file named StdAfx.obj.
